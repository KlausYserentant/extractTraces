function csum = circularSum(matrix, center, radius)
% calculate the sum of values inside a circle with a given radius
    ...
    csum = squeeze(nansum(nansum(matrix(yStart:yFinish, xStart:xFinish, :))));
end