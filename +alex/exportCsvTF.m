function exportCsvTF(filePath, movie, mapping, traces, selectedFrames, concentrationDNA, ...
    concentrationTF, incubationTime, temperature, numberGreen, numberGreenRed)
% export all data from the movie and the traces as a csv file
    ...
    metadata(9, 1:2) = {'concentrationDNA [nM]', concentrationDNA};
    metadata(10, 1:2) = {'concentrationTF [nM]', concentrationTF};
    metadata(11, 1:2) = {'incubationTime [min]', incubationTime};
    metadata(12, 1:2) = {'temperature [°C]', temperature};
    metadata(13, 1:2) = {'numberGreen', numberGreen};
    metadata(14, 1:2) = {'numberGreenRed', numberGreenRed};
