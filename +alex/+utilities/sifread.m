...
if strcmp(data, 'old')
   [data,back,ref]=sifread41200030(file);
   return 
end
...
% Version change 14.12.2009 // changed %d to %f because of real temp values
o=fscanf(f,'%f',6);
...
% Version change 14.12.2009 // Extra Bytes inserted
fscanf(f,'%s',22);
...
skipBytes(f,4);
for n=1:z
% Version change 14.12.2009 // readLine instead of readString
     o=readLine(f);
%    o=readString(f);
   if numel(o)
      fprintf('%s\n',o);      % comments
